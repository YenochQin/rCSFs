//! Serial development baseline: retain per-occupation integer chunks and export once.
//! This is a measurement harness, not the public transcript-generation API.
